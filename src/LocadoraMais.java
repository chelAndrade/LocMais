 ...
 * @author miche
 */
public class LocadoraMais extends javax.swing.JFrame {

    /**
     * Creates new form LocadoraMais
     */
    public LocadoraMais() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LocadoraMais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LocadoraMais().setVisible(true);
            }
        });
    }
